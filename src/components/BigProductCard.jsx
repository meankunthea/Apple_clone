...
const BigProductCard = ({ title, description, image, badge }) => {
  return (
    <div className="shrink-0 w-[480px] h-[500px] rounded-[20px] overflow-hidden shadow-lg transition-transform duration-300 hover:scale-[1.01]">
      <div
